...
> **口径声明**：本文的机制描述、公式与伪代码来自[官方 Attention-Residuals 仓库 README](https://github.com/MoonshotAI/Attention-Residuals)（2026-08-02 抓取，3.4k stars）与[论文页](https://arxiv.org/abs/2603.15031)；**"不到 2% 额外开销带来约 25% 训练效率提升"为主文档引用的官方自报口径**，截至写作日期未见独立复现。推理引擎兼容性部分为本文推测，已明确标注。
...
| 项 | 值 | 来源 / 等级 |
| --- | --- | --- |
| 额外训练开销 | < 2% | 官方博客/主文档 §4.2（**官方自报**，未复现） |
| 训练效率提升 | 约 25% | 官方博客/主文档 §4.2（**官方自报**，未复现） |
...
- **25% 训练效率提升未见独立复现**——该数字出自官方技术博客，属于"官方自报且复现成本极高"类别，按仓库数据原则保留原始口径、不代填；
